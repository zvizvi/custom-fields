...
it('uses weakmap for automatic memory management', function () {
    // Create models
    $model1 = new class extends Model { protected $table = 'test'; };
    $model2 = new class extends Model { protected $table = 'test'; };
    $model3 = new class extends Model { protected $table = 'test'; };
...
it('handles concurrent imports safely', function () {
    $model1 = new class extends Model { protected $table = 'test1'; };
    $model2 = new class extends Model { protected $table = 'test2'; };
...
it('pulls and clears data atomically', function () {
    $model = new class extends Model { protected $table = 'test'; };
...
it('applies validation rules', function () {
    ...
    $field->validation_rules = collect([
        new \Relaticle\CustomFields\Data\ValidationRuleData(
            name: 'required',
            parameters: []
        ),
        new \Relaticle\CustomFields\Data\ValidationRuleData(
