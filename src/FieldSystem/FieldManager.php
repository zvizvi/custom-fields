...
use Relaticle\CustomFields\FieldSystem\Definitions\CheckboxFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\CheckboxListFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\ColorPickerFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\CurrencyFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\DateFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\DateTimeFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\EmailFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\FileUploadFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\LinkFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\MarkdownEditorFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\MultiSelectFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\NumberFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\PhoneFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\RadioFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\RichEditorFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\SelectFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\TagsInputFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\TextareaFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\TextFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\ToggleButtonsFieldType;
use Relaticle\CustomFields\FieldSystem\Definitions\ToggleFieldType;
...
final class FieldManager
{
    ...
    private function isFieldTypeAllowedByConfiguration(string $fieldTypeKey, SystemConfig $config): bool
    {
